...
[glink  color="customized_button"  storage="part1_day3.ks"  size="20"  text="きっと会えるよ"  target="*choice2_1"  width="max"  autopos="true" ]
[glink  color="customized_button"  storage="part1_day3.ks"  size="20"  text="世界の頂点か"  target="*choice2_2" width="max"  autopos="true"  ]
...
[glink  color="customized_button"  storage="part1_day3.ks"  size="20"  text="俺はそうは思わない"  target="*choice3_1"  width="max"  autopos="true" ]
[glink  color="customized_button"  storage="part1_day3.ks"  size="20"  text="内容によるかな"  target="*choice3_2" width="max"  autopos="true"  ]
