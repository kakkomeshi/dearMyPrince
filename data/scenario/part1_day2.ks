...
リョーマ！[p]
#
こちらに気づいたリョーマが、まっすぐ俺の方へ向かってくる。[p]
#リョーマ
……来たんだ[p]
#エリオット
もちろん。[r]
...
[glink  color="customized_button"  storage="part1_day2.ks"  size="20"  text="何が飲みたかった？"  target="*choice1_1"  width="max"  autopos="true" ]
[glink  color="customized_button"  storage="part1_day2.ks"  size="20"  text="炭酸は身体に悪いぞ"  target="*choice1_2" width="max"  autopos="true"  ]
...
[glink  color="customized_button"  storage="part1_day2.ks"  size="20"  text="ファンタグレープ"  target="*choice3_1"  width="max"  autopos="true" ]
[glink  color="customized_button"  storage="part1_day2.ks"  size="20"  text="スポーツドリンク"  target="*choice3_2" width="max"  autopos="true"  ]
